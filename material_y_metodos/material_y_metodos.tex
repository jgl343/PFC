...
\include{material_y_metodos/java}

\include{material_y_metodos/android}

\include{material_y_metodos/gps}

\include{material_y_metodos/json}

\include{material_y_metodos/firebase}

\include{material_y_metodos/nosql}

\include{material_y_metodos/firebaserealtime}
...
\include{material_y_metodos/openweathermap}

\include{material_y_metodos/googleplaylocation}
\include{material_y_metodos/firebasejobdispatcher}
\include{material_y_metodos/firebaseauth}
\section{Herramientas de trabajo}
En esta sección, listaremos una serie de herramientas que utilizaremos
 para desarrollar nuestra aplicación.
\include{material_y_metodos/androidstudio}
\section{Métodos}
En esta sección, vamos a listar una serie de métodos y buenas prácticas 
necesarias para este tipo de aplicación.
\include{material_y_metodos/optimizacion_bateria}